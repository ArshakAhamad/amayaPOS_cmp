...
import { HiHome, HiArrowRight, HiDocumentText, HiCube, HiTruck, } from 'react-icons/hi';
        ...
        <div className="flex flex-col mt-4 w-full">
          ...
          {isHomeOpen && isSidebarOpen && (
            <div className="sub-menu pl-8 mt-2">
              <Link to="/CashierPanel/" className="menu-item flex items-center p-2 hover:bg-blue-100 rounded">
                <span>Dashboard</span>
              </Link>
              <Link to="/CashierPanel/CashInHand" className="menu-item flex items-center p-2 hover:bg-blue-100 rounded">
                <span>Cash In Hand</span>
              </Link>
              <Link to="/CashierPanel/ProductMovement" className="menu-item flex items-center p-2 hover:bg-blue-100 rounded">
          ...
          {isSalesOpen && isSidebarOpen && (
            <div className="sub-menu pl-8 mt-2">
              <Link to="/CashierPanel/POS" className="menu-item flex items-center p-2 hover:bg-blue-100 rounded">
                <span>POS</span>
              </Link>
              <Link to="/CashierPanel/POSReturn" className="menu-item flex items-center p-2 hover:bg-blue-100 rounded">
                <span>POS Return</span>
              </Link>
              <Link to="/CashierPanel/POSReceipts" className="menu-item flex items-center p-2 hover:bg-blue-100 rounded">
                <span>POS Receipts</span>
              </Link>
              <Link to="/CashierPanel/POSReorders" className="menu-item flex items-center p-2 hover:bg-blue-100 rounded">
                <span>POS Reorders</span>
              </Link>
              <Link to="/CashierPanel/POSExpenses" className="menu-item flex items-center p-2 hover:bg-blue-100 rounded">
          ...
          {isVouchersOpen && isSidebarOpen && (
            <div className="sub-menu pl-8 mt-2">
              <Link to="/CashierPanel/VoucherList" className="menu-item flex items-center p-2 hover:bg-blue-100 rounded">
                <span>Voucher List</span>
              </Link>
              <Link to="/CashierPanel/AddVouchers" className="menu-item flex items-center p-2 hover:bg-blue-100 rounded">
          ...
          {isUserManagementOpen && isSidebarOpen && (
            <div className="sub-menu pl-8 mt-2">
              <Link to="/CashierPanel/Profile" className="menu-item flex items-center p-2 hover:bg-blue-100 rounded">
                <span>Profile</span>
              </Link>
              <Link to="/CashierPanel/SalesRepList" className="menu-item flex items-center p-2 hover:bg-blue-100 rounded">
                <span>Sales Rep List</span>
              </Link>
              <Link to="/CashierPanel/New" className="menu-item flex items-center p-2 hover:bg-blue-100 rounded">
                <span>New</span>
              </Link>
            </div>
          )}
...
<div>
  ...
  {isContactsOpen && isSidebarOpen && (
    <div className="sub-menu pl-8 mt-2">
      <Link to="/CashierPanel/CustomerList" className="menu-item flex items-center p-2 hover:bg-blue-100 rounded">
        <span>Customer List</span>
      </Link>
      <Link to="/CashierPanel/NewCustomer" className="menu-item flex items-center p-2 hover:bg-blue-100 rounded">
        <span>New</span>
      </Link>
    </div>
  )}
