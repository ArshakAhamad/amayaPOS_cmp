...
const CustomerList = () => {
  ...
  const handleEditSubmit = async (e) => {
    ...
    try {
      ...
      setError(err.response?.data?.message || 'An error occurred while updating customer.');
    }
  };
      ...
      {isEditModalOpen && currentCustomer && (
          ...
          <div className="bg-white rounded-lg shadow-xl w-full max-w-md">
            ...
            <form onSubmit={handleEditSubmit} className="p-4">
              ...
              <div className="mb-4 flex items-center">
                ...
                />   <br></br>
                <label htmlFor="customer_active" className="ml-2 block text-sm text-gray-700">
                  Active Customer
                </label>
              </div>
        ...
        <div className="mt-6 flex flex-col sm:flex-row justify-between items-center gap-4">
          <div className="text-sm text-gray-600">
            ...
            <span className="font-medium">{Math.min(currentPage * entriesPerPage, filteredCustomers.length)}</span>{' '}
